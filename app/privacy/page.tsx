  ...
  return (
    <article className="px-4 py-10 text-sm leading-relaxed text-fg-muted">
      ...
      <section className="mt-6">
        <h2 className="font-display text-base text-fg">1. 수집하는 개인정보</h2>
        <p className="mt-2">
      ...
      <section className="mt-6">
        <h2 className="font-display text-base text-fg">2. 쿠키 및 광고</h2>
        <p className="mt-2">
      ...
      <section className="mt-6">
        <h2 className="font-display text-base text-fg">3. 분석 도구</h2>
        <p className="mt-2">
      ...
      <section className="mt-6">
        <h2 className="font-display text-base text-fg">4. 데이터 출처</h2>
        <p className="mt-2">
      ...
      <section className="mt-6">
        <h2 className="font-display text-base text-fg">5. 문의</h2>
        <p className="mt-2">
